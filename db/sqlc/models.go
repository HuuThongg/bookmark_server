...
type Folder struct {
	...
	FolderCreatedAt        pgtype.Timestamptz `json:"folder_created_at"`
	FolderUpdatedAt        pgtype.Timestamptz `json:"folder_updated_at"`
...
type MemberInvite struct {
	...
	InviteExpiry            pgtype.Timestamptz `json:"invite_expiry"`
